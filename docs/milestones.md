...
Status: IN IMPLEMENTATION — Supabase-primary Preview acceptance selesai; Production tetap Google Sheets. Observation window, Production compatibility, cutover, rollback, dan deprecation Google Sheets masih pending.
