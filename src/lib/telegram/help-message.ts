...
const HELP_SECTIONS: Array<{ title: string; entries: HelpEntry[] }> = [
  ...
  },
  {
    ...
    entries: [
      ...
      { command: "/planincome <jumlah> [CURRENCY] <YYYY-MM-DD> [MONTHLY] <deskripsi>", description: "Membuat rencana pendapatan.", audience: "ACTIVE" },
      { command: "/planexpense <jumlah> [CURRENCY] <YYYY-MM-DD> [MONTHLY] <deskripsi>", description: "Membuat rencana pengeluaran.", audience: "ACTIVE" },
      { command: "/liability <jumlah> [CURRENCY] <YYYY-MM-DD> MONTHLY <deskripsi>", description: "Membuat recurring liability.", audience: "ACTIVE" },
      { command: "/plans", description: "Melihat rencana keuangan aktif.", audience: "ACTIVE" },
