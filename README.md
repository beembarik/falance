...
| `/invite` | `OWNER`, `ADMIN` | Membuat invitation code baru untuk keluarga actor. Kode ditampilkan sebagai inline code agar mudah disalin. Masa berlaku default adalah 24 jam dan dapat dikonfigurasi melalui environment variable. Mini App menyediakan pesan siap-share dengan tautan bot dan instruksi `/join <code>`. |
