...
| Receipt photo intake | Photo receipt dari anggota aktif divalidasi, diunduh melalui `getFile` secara server-side, lalu diarahkan ke receipt parser vision. Gambar tidak disimpan ke Google Sheets dan transaksi tidak dibuat sebelum approval draft. | Tahap awal Milestone 7 |
