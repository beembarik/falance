...
| Telegram Mini App | UI read-only mobile-first, endpoint report yang memvalidasi raw `initData`, launcher `/reportapp`, filter bulan/rentang tanggal maksimal 366 hari, daftar maksimal 50 transaksi terbaru, serta tombol CSV, tampilan cetak, dan PDF hanya untuk `OWNER`/`ADMIN`. | Milestone 9 Slice 2–5 tersedia |
